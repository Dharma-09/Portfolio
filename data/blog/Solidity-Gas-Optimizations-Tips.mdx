---
title: Solidity Gas Optimizations Tips
date: '2022-12-10'
tags: [solidity, smart contract,gas optimization]
draft: false
summary: This article is going to give you a couple of tips to reduce gas consumption in your .
---
<img
...
```
## 6.++i/i++ should be unchecked{++i}/unchecked{i++}
when it is not possible for them to overflow, as is the case when used in for- and while-loops.The unchecked keyword is new in solidity version 0.8.0, so this only applies to that version or higher, which these instances are. 
